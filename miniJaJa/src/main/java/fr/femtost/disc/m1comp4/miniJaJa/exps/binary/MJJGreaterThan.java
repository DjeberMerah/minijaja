...
public class MJJGreaterThan extends MJJBinaryExp {

    public MJJGreaterThan(MJJExp left_exp, MJJExp right_exp, int line, int column) { super(left_exp, right_exp, line, column); }
